...
- Use minimal-values.yaml inside charts/spinnaker folder Ex: https://github.com/keerthibingi/spinnaker-helm/blob/1.30.1/charts/spinnaker/minimal-values.yaml
